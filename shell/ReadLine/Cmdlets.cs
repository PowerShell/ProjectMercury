...
#pragma warning disable 1591
    ...
    public class PSConsoleReadLineOptions
    {
        ...
        /// </summary>
        public Func<string, AddToHistoryOption> AddToHistoryHandler { get; set; }
        public static readonly Func<string, AddToHistoryOption> DefaultAddToHistoryHandler =
    ...
    public class SetPSReadLineOption
    {
        ...
        internal bool? _historyNoDuplicates;

        public Func<string, AddToHistoryOption> AddToHistoryHandler
        {
        ...
        private Func<string, AddToHistoryOption> _addToHistoryHandler;
        internal bool _addToHistoryHandlerSpecified;

        public bool HistorySearchCursorMovesToEnd
        {
            get => _historySearchCursorMovesToEnd.GetValueOrDefault();
            set => _historySearchCursorMovesToEnd = value;
        }
        internal bool? _historySearchCursorMovesToEnd;
    ...
    public static class VTColorUtils
    {
        ...
        internal const string DefaultColor = "\x1b[36;49m";
