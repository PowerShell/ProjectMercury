...
namespace Microsoft.PowerShell
{
    ...
    public partial class PSConsoleReadLine
    {
        ...
        /// </summary>
        private void CalculateWhereAndWhatToRender(RenderData renderData, out LineInfoForRendering lineInfoForRendering)
        {
        ...
        private void ReallyRender(RenderData renderData, string defaultColor)
        {
            ...
            CalculateWhereAndWhatToRender(renderData, out LineInfoForRendering lineInfoForRendering);
